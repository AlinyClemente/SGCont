...
public class Endereco {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator="cadastro.seq_endereco")
	@SequenceGenerator(name="cadastro.seq_endereco", sequenceName="cadastro.seq_endereco")
